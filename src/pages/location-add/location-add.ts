...
import { CustomAuthorizerClient, IamAuthorizerClient } from "../../services/vistaloc-api.service";
...
export class LocationAddPage {
  ...
  public formData = {
    name: "",
    description: "",
    imageUrl: "https://s3.amazonaws.com/vistaloc-public-image-repository/building.png"
  };
